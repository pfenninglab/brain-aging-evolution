...
table(proj$Status, proj$geneset_neg24.y)
...
proj$Sample_Geneset <- paste(
  proj$id,
  proj$geneset_neg24.y,   # intrinsic/systemic
  sep = "#"
)
...
# Save results
diff_results_file = 
paste0('Anderson_PFC_AD_Inh_neg24_diffPeakList_byModel.rds') %>% 
here(DATADIR, 'rdas', .)
